...
namespace cvui
{
extern double CVUI_DEFAULT_FONT_SCALE;
...
*/
bool button(cv::Mat& theWhere, int theX, int theY, const cv::String& theLabel, double theFontScale = CVUI_DEFAULT_FONT_SCALE, unsigned int theInsideColor = DEFAULT_BUTTON_COLOR);
...
/**
 ...
 \return `true` everytime the user clicks the button.
*/
bool button(cv::Mat& theWhere, int theX, int theY, int theWidth, int theHeight, const cv::String& theLabel, double theFontScale = CVUI_DEFAULT_FONT_SCALE, unsigned int theInsideColor = DEFAULT_BUTTON_COLOR);
...
*/
bool checkbox(cv::Mat& theWhere, int theX, int theY, const cv::String& theLabel, bool *theState, unsigned int theColor = 0xCECECE, double theFontScale = CVUI_DEFAULT_FONT_SCALE);
...
/**
 ...
 \sa printf()
*/
void text(cv::Mat& theWhere, int theX, int theY, const cv::String& theText, double theFontScale = CVUI_DEFAULT_FONT_SCALE, unsigned int theColor = 0xCECECE);
...
*/
int counter(cv::Mat& theWhere, int theX, int theY, int *theValue, int theStep = 1, const char *theFormat = "%d", double theFontScale = CVUI_DEFAULT_FONT_SCALE, unsigned int theInsideColor = DEFAULT_BUTTON_COLOR);
...
*/
double counter(cv::Mat& theWhere, int theX, int theY, double *theValue, double theStep = 0.5, const char *theFormat = "%.2f", double theFontScale = CVUI_DEFAULT_FONT_SCALE, unsigned int = DEFAULT_BUTTON_COLOR);
...
*/
template <typename T>
bool trackbar(cv::Mat& theWhere, int theX, int theY, int theWidth, T *theValue, T theMin, T theMax, int theSegments = 1, const char *theLabelFormat = "%.1Lf", unsigned int theOptions = 0, T theDiscreteStep = 1, double theFontScale = CVUI_DEFAULT_FONT_SCALE);
...
/**
 ...
 \sa rect()
*/
void window(cv::Mat& theWhere, int theX, int theY, int theWidth, int theHeight, const cv::String& theTitle, double theFontScale = CVUI_DEFAULT_FONT_SCALE);
...
/**
 ...
 \sa endColumn()
*/
void text(const cv::String& theText, double theFontScale = CVUI_DEFAULT_FONT_SCALE, unsigned int theColor = 0xCECECE);
...
/**
 ...
 \sa endColumn()
*/
bool button(int theWidth, int theHeight, const cv::String& theLabel, double theFontScale = CVUI_DEFAULT_FONT_SCALE, unsigned int theInsideColor = DEFAULT_BUTTON_COLOR);
...
/**
 ...
 \sa endColumn()
*/
bool button(const cv::String& theLabel, double theFontScale = CVUI_DEFAULT_FONT_SCALE, unsigned int theInsideColor = DEFAULT_BUTTON_COLOR);
...
/**
 ...
 \sa endColumn()
*/
bool checkbox(const cv::String& theLabel, bool *theState, unsigned int theColor = 0xCECECE, double theFontScale = CVUI_DEFAULT_FONT_SCALE);
...
\sa endColumn()
*/
int counter(int *theValue, int theStep = 1, const char *theFormat = "%d", double theFontScale = CVUI_DEFAULT_FONT_SCALE, unsigned int theInsideColor = DEFAULT_BUTTON_COLOR);
...
/**
 ...
 \sa endColumn()
*/
double counter(double *theValue, double theStep = 0.5, const char *theFormat = "%.2f", double theFontScale = CVUI_DEFAULT_FONT_SCALE, unsigned int theInsideColor = DEFAULT_BUTTON_COLOR);
...
bool trackbar(int theWidth, T *theValue, T theMin, T theMax, int theSegments = 1, const char *theLabelFormat = "%.1Lf", unsigned int theOptions = 0, T theDiscreteStep = 1, double theFontScale = CVUI_DEFAULT_FONT_SCALE);
...
/**
 ...
 \sa endColumn()
*/
void window(int theWidth, int theHeight, const cv::String& theTitle, double theFontScale = CVUI_DEFAULT_FONT_SCALE);
...
namespace internal
{
	...
	struct TrackbarParams {
		...
		inline TrackbarParams()
			...
			, options(0)
			, labelFormat("%.0Lf")
			, fontScale(CVUI_DEFAULT_FONT_SCALE)
		{}
	};
	...
	TrackbarParams makeTrackbarParams(T min, T max, int theDecimals = 1, int theSegments = 1, T theStep = -1., unsigned int theOptions = 0, const char *theFormat = "%.1Lf", double theFontScale = CVUI_DEFAULT_FONT_SCALE);
...
namespace cvui
{
double CVUI_DEFAULT_FONT_SCALE = 0.4;
...
namespace internal
{
	...
	bool button(cvui_block_t& theBlock, int theX, int theY, const cv::String& theLabel, double theFontScale, unsigned int theInsideColor) {
		...
		return internal::button(theBlock, theX, theY, aTextSize.width + std::lround(30*theFontScale/CVUI_DEFAULT_FONT_SCALE), aTextSize.height + std::lround(18* theFontScale / CVUI_DEFAULT_FONT_SCALE), theLabel, true, theFontScale, theInsideColor);
	}
	...
	int counter(cvui_block_t& theBlock, int theX, int theY, int *theValue, int theStep, const char *theFormat, double theFontScale, unsigned int theInsideColor) {
		const double scale = theFontScale / CVUI_DEFAULT_FONT_SCALE;
	...
	bool trackbar(cvui_block_t& theBlock, int theX, int theY, int theWidth, long double *theValue, const TrackbarParams & theParams) {
		cvui_mouse_t& aMouse = internal::getContext().mouse;
		cv::Rect aContentArea(theX, theY, theWidth, std::lround(45*theParams.fontScale/CVUI_DEFAULT_FONT_SCALE));
	...
	void window(cvui_block_t& theBlock, int theX, int theY, int theWidth, int theHeight, const cv::String& theTitle, double theFontScale) {
		cv::Rect aTitleBar(theX, theY, theWidth, std::lround(20*theFontScale/CVUI_DEFAULT_FONT_SCALE));
	...
	void sparkline(cvui_block_t& theBlock, std::vector<double>& theValues, int theX, int theY, int theWidth, int theHeight, unsigned int theColor) {
		...
		if (aHowManyValues >= 2) {
			...
			internal::text(theBlock, theX, theY, aHowManyValues == 0 ? "No data." : "Insufficient data points.", CVUI_DEFAULT_FONT_SCALE, 0xCECECE, false);
		}
...
namespace render
{
	...
	void trackbarHandle(cvui_block_t& theBlock, int theState, cv::Rect& theShape, double theValue, const internal::TrackbarParams &theParams, cv::Rect& theWorkingArea) {
		const double scale = theParams.fontScale/CVUI_DEFAULT_FONT_SCALE;
	...
	void trackbarSegmentLabel(cvui_block_t& theBlock, cv::Rect& theShape, const internal::TrackbarParams &theParams, long double theValue, cv::Rect& theWorkingArea, bool theShowLabel) {
		...
		cv::Point aPoint1(aPixelX, aBarTopLeft.y);
		cv::Point aPoint2(aPixelX, aBarTopLeft.y - std::lround(8*theParams.fontScale/CVUI_DEFAULT_FONT_SCALE));
		cv::line(theBlock.where, aPoint1, aPoint2, aColor);

		if (theShowLabel)
		{
			sprintf_s(internal::gBuffer, theParams.labelFormat.c_str(), theValue);
			cv::Point aTextPos(aPixelX, aBarTopLeft.y - std::lround(11*theParams.fontScale/CVUI_DEFAULT_FONT_SCALE));
			putTextCentered(theBlock, aTextPos, internal::gBuffer, theParams.fontScale-0.1);
		}
  }
	...
	void window(cvui_block_t& theBlock, cv::Rect& theTitleBar, cv::Rect& theContent, const cv::String& theTitle, double theFontScale) {
		...
		// Render title text.
		cv::Point aPos(theTitleBar.x + 5, theTitleBar.y + std::lround(12 * theFontScale/CVUI_DEFAULT_FONT_SCALE));
...
void printf(cv::Mat& theWhere, int theX, int theY, const char *theFmt, ...) {
	...
	internal::gScreen.where = theWhere;
	internal::text(internal::gScreen, theX, theY, internal::gBuffer, CVUI_DEFAULT_FONT_SCALE, 0xCECECE, true);
}
...
void printf(const char *theFmt, ...) {
	...
	internal::text(aBlock, aBlock.anchor.x, aBlock.anchor.y, internal::gBuffer, CVUI_DEFAULT_FONT_SCALE, 0xCECECE, true);
}
